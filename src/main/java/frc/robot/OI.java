...
import frc.robot.commands.drive.C_PowerDrive;
...
import frc.robot.commands.electropneumatic.C_HookEngage;
...
import frc.robot.commands.loops.L_DisableManager;
...
public class OI {
  ...
  xb1_Rstick.whenPressed(new C_PowerDrive());
  xb1_Rstick.whenReleased(new C_RegressedDrive());
...
//----------------XBOX 2------------------------------------------------------------
  ...
  xb2_RB.whileHeld(new C_HatchForward());
  xb2_LB.whileHeld(new C_HatchReverse());

  xb2_A.whileHeld(new C_HookEngage());

  xb2_Start.whileHeld(new C_ZeroIntake());

  xb2_Select.whileHeld(new L_DisableManager());
  xb2_Select.whileHeld(new C_ClimbEngage());
  xb2_Select.whileHeld(new C_IntakeOut());
