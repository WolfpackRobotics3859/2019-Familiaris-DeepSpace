...
import frc.robot.commands.electropneumatic.C_ShifterEngage;
...
public class Robot extends TimedRobot {
  ...
  public static C_ShifterEngage cShifterEngage;
  public static C_HookEngage cHookEngage;
  ...
  public void robotInit() {
    ...
    cHookEngage = new C_HookEngage();
    cShifterEngage = new C_ShifterEngage();
    cClimbEngage = new C_ClimbEngage();
