...
public class RobotMap {
  ...
  public static int hatchDeploy_ds_kForward = 4;
  public static int hatchDeploy_ds_kReverse = 7;
  ...
  public static int climb_ds_kForward = 5;
  public static int climb_ds_kReverse = 6;
