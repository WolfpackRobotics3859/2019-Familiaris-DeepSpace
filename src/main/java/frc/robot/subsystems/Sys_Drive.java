...
public class Sys_Drive extends Subsystem {
  ...
  public void regressionDrive(double leftSpeed, double rotateAxisInput) {
    ...
    enableGroupVoltageCompensation(false);
...
public void rapidCurvatureDrive(double drive, double steer){
  ...
  enableGroupVoltageCompensation(true);
...
private void enableGroupVoltageCompensation(boolean request){
  t1.enableVoltageCompensation(request);
  t2.enableVoltageCompensation(request);
  t4.enableVoltageCompensation(request);
  t3.enableVoltageCompensation(request);
  t5.enableVoltageCompensation(request);
  t6.enableVoltageCompensation(request);
}
